/*5. Define a structure time to represent time (hours, minutes, seconds). Write functions
to add two time values and display the result. Use pass-by-reference to modify the
original time structures.*/
